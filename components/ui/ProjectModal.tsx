            ...
            >
              ...
              >
                <div className="relative w-full overflow-hidden rounded-[24px] bg-black/90 backdrop-blur-2xl p-6 md:p-8 shadow-[0_0_80px_rgba(0,0,0,0.8)]">
                  ...
                  <button
                    onClick={() => setSelectedProject(null)}
                    className="absolute top-4 right-4 md:-top-3 md:-right-3 z-50 flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-full bg-black/70 text-white/60 transition hover:text-white hover:bg-black/90 border border-white/10 md:border-none"
